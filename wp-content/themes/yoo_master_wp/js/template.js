...
$.extend($.validator, {
	...
	messages: {
		...
		date: "Xin nhập ngày tháng hợp lệ. (định dạng nn/tt/nnnn, vd: 05/02/2000)",
	...
	methods: {
		...
		date: function( value, element ) {
			return this.optional(element) || /^(((0[1-9]|[12]\d|3[01])\/(0[13578]|1[02])\/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\/(0[13456789]|1[012])\/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\/02\/((19|[2-9]\d)\d{2}))|(29\/02\/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$/.test(value);//!/Invalid|NaN/.test(new Date(value).toString());
		},
...
(function($){
	...
	$(document).ready(function() {
	$("#captchaimage").on('click', '#refreshimg', function(){
...
//danh cho form kich hoat
	var validator = $(".form_profile").validate({
		rules: {
			...
			hcpassword: {required: true, minlength:6,maxlength:15},
			hcconfirm_pass: {required: true, minlength:6,maxlength:15,equalTo: "#password"},
			hcmobile: {required: true,number: true,minlength:7,maxlength:12},
			hccompanyphone: {required: false,number: true,minlength:7,maxlength:12},
			recaptcha_response_field:{required:true},
			//for form change pass:
			current_pass:{required: true, minlength:6,maxlength:15},
			new_pass:{required: true, minlength:6,maxlength:15},
			confirm_pass: {required: true, minlength:6,maxlength:15,equalTo: "#password"},
		},
		messages: {
			email: {
...
var validator = $(".form_profile2").validate({
		rules: {
			...
			hcconfirm_pass: {required: true, minlength:6,maxlength:15,equalTo: "#password"},
			hcmobile: {required: true,number: true,minlength:7,maxlength:12},
			companyphone: {required: false,number: true,minlength:7,maxlength:12}
		},
		messages: {
			email: {
				required: 'Xin nhập địa chỉ email!'
