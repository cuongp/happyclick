                ...
                <div class="content-box-inside">
                    ...
                    <article id="item-<?php the_ID(); ?>" class="item courses" data-permalink="<?php the_permalink(); ?>">
                        <div class="content clearfix hoc-qua-video">
                            ...
                            ?>
                            <iframe width="560" height="414" src="<?php echo $youtubeVideo_link; ?>?showinfo=0&rel=0" frameborder="0" allowfullscreen style="border: 1px solid #ddd; box-shadow: 0px 2px 25px #aaa;" ></iframe>
                        </div>
