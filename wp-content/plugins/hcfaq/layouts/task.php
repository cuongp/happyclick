        ...
        <div class="tabs-box">
            <ul class="nav">
                ...
                if($_GET['options']=='subscription')
                    $subscription = 'active';
                ?>
                <li class="<?php echo $homepage.' '.$service ?>"><a href="?page=hcfaq&options=service">Our Services</a> </li>
                <li class="<?php echo $error ?>" ><a href="?page=hcfaq&options=error">Errors</a> </li>
                <li class="<?php echo $complaint ?>"><a href="?page=hcfaq&options=complaint">Complaints</a> </li>
                <li class="<?php echo $statistics ?>" ><a href="?page=hcfaq&options=statistics">Statistics</a> </li>
                <li class="<?php echo $subscription ?>" ><a href="?page=hcfaq&options=subscription">Subscription</a> </li>
            </ul>
